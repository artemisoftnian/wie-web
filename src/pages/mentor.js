    ...
    body: () => (
      <ul>
        ...
        <li>
          ...
          wiecare leadership If there are signs a person might be a danger to themselves or
          others
        </li>
      </ul>
    ),
              ...
              <div className="col-xs-12">
                <div className="contactus-brief">
                  ...
                  <p className="section-description">
                    Thank you for your interest in mentoring with wiecare. This document is
                  ...
                  <div className="container">
                    ...
                    wiecare is a virtual organization and Slack is the primary vehicle for
