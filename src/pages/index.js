            ...
            <div className="col-md-3">
              <Link to="/donate">
                ...
                >
                  ...
                  <h3 style={{color:"#ffffff", marginTop:30}}>Make a donation</h3>
                </div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/mentor">
                ...
                >
                  <h3 style={{color:"#ffffff", marginTop:30}}>Become a volunteer</h3>
                </div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/mentor">
                ...
                >
                  <h3 style={{color:"#ffffff", marginTop:20}}>Donate your Birthday and Anniversary</h3>
                </div>
              </Link>
            </div>            
          </div>
          ...
          <div className="row bg-dark">
            ...
            <div className="col-md-7 col-sm-12 our_story_content text-center">
              <div className="featured-heading">
                <h2>WIE Care, Can & Will <br></br>Make a Difference</h2>
              </div>
              <p>
          ...
          <div className="row">
            <div className="col-sm-6 event_content">
              ...
              <div className="event_excerpt">
                <p>Fund Raising Event October 2021</p>
              </div>
            </div>
            <div  className="col-sm-6 event_counter_container text-center">
              <Countdown />
              <Link className="btn btn-charity-default" style={{display: 'none'}} to="/apply">
                Apply
              </Link>
            </div>
          </div>
