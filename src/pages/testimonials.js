        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 lead-in">
              ...
              <p>
                <i>
                  While we are proud of all the veterans we have helped at wiecare, here are
                ...
                <div className="testimonial-row">
                  ...
                  <blockquote className="testimonial-text">
                    <p>
                      ...
                      life for the better.  Work Initiative And Entrepreneurship delivered more value to me than 12 of the
